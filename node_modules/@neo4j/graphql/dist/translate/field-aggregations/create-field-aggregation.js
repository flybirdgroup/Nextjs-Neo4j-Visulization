...
function createFieldAggregation({ context, nodeLabel, node, field, }) {
    ...
    if (aggregationFields.count) {
        countFunction = cypher_builder_1.default.count(sourceRef);
        projectionMap.set({
            count: countRef,
        });
...
function getAggregationProjectionAndSubqueries({ referenceNode, matchWherePattern, targetRef, sourceRef, fields, }) {
    ...
    Object.values(fields).forEach((field) => {
        const dbProperty = (0, map_to_db_property_1.default)(referenceNode, field.name);
