...
function createConnectionOperation({ connectionField, value, context, parentNode, operator, }) {
    ...
    Object.entries(nodeEntries).forEach((entry) => {
        ...
        const subquery = new cypher_builder_1.default.RawCypher((env) => {
    ...
    return { predicate: cypher_builder_1.default.and(...operations), preComputedSubqueries: subqueries };
}
...
function createConnectionWherePropertyOperation({ context, whereInput, edgeRef, targetNode, node, edge, }) {
    ...
    return {
        ...
        preComputedSubqueries: cypher_builder_1.default.concat(...preComputedSubqueriesResult),
    };
}
