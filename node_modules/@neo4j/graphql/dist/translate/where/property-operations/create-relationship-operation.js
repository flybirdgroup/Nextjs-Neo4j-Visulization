...
function createRelationshipOperation({ relationField, context, parentNode, operator, value, isNot, }) {
    ...
    const { predicate: relationOperator, preComputedSubqueries } = (0, create_where_predicate_1.createWherePredicate)({
    ...
    switch (operator) {
        case "ALL": {
            ...
            return {
                predicate: cypher_builder_1.default.and(new cypher_builder_1.default.Exists(existsMatch), cypher_builder_1.default.not(new cypher_builder_1.default.Exists(existsMatchNot))),
        ...
        case "NONE": {
            ...
            return { predicate: cypher_builder_1.default.not(existsPredicate), preComputedSubqueries };
        }
        case "SINGLE": {
            const patternComprehension = new cypher_builder_1.default.PatternComprehension(matchPattern, childNode);
            return {
                predicate: cypher_builder_1.default.single(childNode, patternComprehension, relationOperator),
                preComputedSubqueries,
            };
        }
        case "SOME":
